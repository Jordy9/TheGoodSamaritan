...
export const sendEmailToPetition = (name) => {
    return async(dispatch, getState) => {
        ...
        user?.map(filtroUserEmail => arregloFiltroUserEmail?.push(filtroUserEmail?.email))

        const subject = 'Hay una nueva petición de oración'

        const title = 'Nueva petición de oración'
    ...
    <meta content="text/html;charset=UTF-8" http-equiv="Content-Type"></head><body bgcolor="#050505" style="margin:0; padding:0;font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#000000;"><center> 
    <div class="zppage-container">                                                          
            <table bgcolor="#050505" border="0" cellpadding="0" cellspacing="0" class="contentOuter" id="contentOuter" style="background-color:#f0f0f0;background-color:#050505;font-size:12px;text-align:center;border:0px;padding:0px;border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" width="100%"> 
                <tbody><tr> 
                    ...
                    <td align="center" style="border:0px;padding:0px;border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                        <table bgcolor="#040405" border="0" cellpadding="0" cellspacing="0" class="contentInner" id="contentInner" style="border-collapse:collapse; border:0px;font-size:12px;background-color:#ffffff;background-color:#040405;width:600px;margin:0px auto;border:0px;" width="600"> 
                        <tbody><tr> 
